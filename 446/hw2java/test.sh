...
java -cp lib/weka.jar:bin FeatureGenerator ../badges/badges.modified.data.all ./../badges.example.arff
...
java -cp lib/weka.jar:bin WekaTester ./../badges.example.arff

read -p "put something here"